...
"EuroSchool Whitefield": {
  ...
  scoreAdjustments: {
    af: 68, // Lowered from 75 — fees likely ₹1.2-1.8L, not ₹1.2-1.5L. Over budget at higher grades.
    di: 80  // Raised from 75 — Bureau Veritas certification is a genuine differentiator
  },
  scoringRationale: {
    af: "Fees need verification — ranges from ₹90K to ₹1.97L across sources. Likely ₹1.2-1.5L for Class 1 but escalates. Budget risk at higher grades. Lowered score.",
...
"Presidency School East": {
  ...
  scoreAdjustments: {
    ...
    ad: 82   // Slightly lowered — expanding but rapid growth may change dynamics
  },
  scoringRationale: {
    af: "₹1-1.2L confirmed. Very affordable. BUT 30% annual fee escalation reported — could reach ₹1.5L within 2-3 years. Hidden cost risk.",
